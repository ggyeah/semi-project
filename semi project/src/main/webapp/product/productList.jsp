...
<!------------ 페이지네이션 ------------>
	...
	<div class="col-lg-12">
		...
		%>
			<a href="<%=request.getContextPath()%>/product/productList.jsp?currentPage=<%=minPage - 1%>"><i class="fa fa-long-arrow-left"></i></a>
		<%
			}
		%> 
		...
		%>
			<a href="<%=request.getContextPath()%>/product/productList.jsp?currentPage=<%=i%>">
			<%=i%></a>
		<%
			}
		%>
		...
		%>
		    <a href="<%=request.getContextPath()%>/product/productList.jsp?currentPage=<%=maxPage + 1%>"><i class="fa fa-long-arrow-right"></i></a>
		<%
			}
		%>    
		</div>
