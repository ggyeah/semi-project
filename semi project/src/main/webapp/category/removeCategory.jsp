...
<meta charset="UTF-8">
    ...
    <title>removeCategory | Template</title>
...
<div>
	...
	<h1>카테고리 삭제</h1>
	<form action="<%=request.getContextPath()%>/category/removeCategoryAction.jsp" method="post">
		<div>	
			<table class="table">
				<tr>
					<th>삭제할 카테고리 이름을 선택해 주세요</th>
				</tr>
				<tr>
					<td>
						<select class="form-select" name="removeCategoryName">
							<%
